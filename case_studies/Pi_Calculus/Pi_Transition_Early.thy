  ...
  subgoal premises prems for R B P Q
    by (tactic \<open>
      ...
      in refreshability_tac false
        ...
        [SOME [NONE, SOME fa, SOME rr, NONE],
         NONE,
        ...
        @{thms emp_bound singl_bound insert_bound_UNIV card_of_minus_bound term.Un_bound
          term.set_bd_UNIV commit.FVars_bd_UNIVs infinite_UNIV bns_bound}
        @{thms } @{thms term.permute_cong_id term.permute_cong_id[symmetric]}
