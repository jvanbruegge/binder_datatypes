...
lift_definition set1_F' :: "('a1::var,'a2::var,'a3::var,'a4) F' \<Rightarrow> 'a1 set" is set1_F .
lift_definition set2_F' :: "('a1::var,'a2::var,'a3::var,'a4) F' \<Rightarrow> 'a2 set" is set2_F .
lift_definition set3_F' :: "('a1::var,'a2::var,'a3::var,'a4) F' \<Rightarrow> 'a3 set" is set3_F .
lift_definition set4_F' :: "('a1::var,'a2::var,'a3::var,'a4) F' \<Rightarrow> 'a4 set" is set4_F .

definition asSS :: "('a \<Rightarrow> 'a) \<Rightarrow> 'a \<Rightarrow> 'a" where
  "asSS f \<equiv> if |supp f| <o |UNIV :: 'a set| then f else id"

lift_definition map_F' :: "('a1::var \<Rightarrow> 'a1) \<Rightarrow> ('a2::var \<Rightarrow> 'a2) \<Rightarrow> ('a3::var \<Rightarrow> 'a3) \<Rightarrow> ('a4 \<Rightarrow> 'a4') 
...
lift_definition rrel_F' :: "('a4 \<Rightarrow> 'a4' \<Rightarrow> bool) \<Rightarrow> ('a1::var,'a2::var,'a3::var,'a4) F' \<Rightarrow> ('a1,'a2,'a3,'a4') F' \<Rightarrow> bool"
  is "rrel_F (=)" .
...
lemma F'_rel_comp_leq_: "rrel_F' Q OO rrel_F' R \<le> rrel_F' (Q OO R)"
  ...
  apply (auto simp: F.rel_compp[of "(=)", simplified])
  done
...
lemma F'_in_rel:
  ...
  subgoal for z
    ...
    apply (auto simp: F.set_map supp_id_bound F.map_comp Grp_def
      intro!: F.map_cong nonrep2_map_F_rev[OF bij_id supp_id_bound, of fst])
    done
  subgoal for z
...
lemma F'_strong:
  ...
  using assms apply transfer using F_strong unfolding mr_rel_F_def F.map_id by fastforce
...
mrbnf "('a::var, 'b::var, 'c::var, 'd) F'"
  ...
  subgoal by (auto simp: F'_set4_map_)
