...
type_synonym T = "ilterm \<times> ilterm"
...
unfolding G_def apply(elim disjE)
  ...
  by (metis image_in_bij_eq iltermP.rrename_bijs iltermP.rrename_inv_simps) . . .
...
corollary strong_induct_reneqv[consumes 2, case_names iVr iLm iAp]: 
