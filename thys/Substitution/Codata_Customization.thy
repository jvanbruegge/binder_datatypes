...
(*******************************)
(* 1. Pre-codatatype assumptions about G: *)
...
yielding the codatatype E and its 
theorems: *)
...
lemma f0_mapD:
  assumes "bij (g::'a\<Rightarrow>'a)" and "|supp g| <o |UNIV::'a::covar_G set|" "valid_U d"
  shows "alpha_E (f0 (raw_Umap g d)) (Eperm_raw g (f0 d))"
