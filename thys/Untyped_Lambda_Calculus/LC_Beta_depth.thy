...
| AppL: "stepD d e1 e1' \<Longrightarrow> stepD (Suc d) (Ap e1 e2) (Ap e1' e2)"
| AppR: "stepD d e2 e2' \<Longrightarrow> stepD (Suc d) (Ap e1 e2) (Ap e1 e2')"
...
binder_inductive stepD
  subgoal premises prems for R B d t1 t2
    by (tactic \<open>refreshability_tac false
      [@{term "(\<lambda>_. {}) :: nat \<Rightarrow> var set"}, @{term "FV :: trm \<Rightarrow> var set"}, @{term "FV :: trm \<Rightarrow> var set"}]
